...
public class SandboxArreglos
{
    ...
    {
        // Usar el algoritmo de ordenamiento por selección
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
        ...
        int[] copiaActual = getCopiaEnteros();
        int[] copiaOtro = otroArreglo.clone();

        java.util.Arrays.sort(copiaActual);
        java.util.Arrays.sort(copiaOtro);

        return java.util.Arrays.equals(copiaActual, copiaOtro);
    }
