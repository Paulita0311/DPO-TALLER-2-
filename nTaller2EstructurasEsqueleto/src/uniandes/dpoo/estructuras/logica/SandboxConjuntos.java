...
public class SandboxConjuntos
{
    ...
    public List<String> getCadenasComoLista() {
        return new ArrayList<>(arbolCadenas); // Convertimos el NavigableSet en una lista ordenada.
    }
    ...
    public List<String> getCadenasComoListaInvertida() {
        return new ArrayList<>(arbolCadenas.descendingSet()); // Utilizamos descendingSet para obtener el conjunto en orden inverso.
    }
    ...
    public String getPrimera() {
        return arbolCadenas.isEmpty() ? null : arbolCadenas.first(); // Usamos first() para obtener la menor cadena.
    }
    ...
    public String getUltima() {
        return arbolCadenas.isEmpty() ? null : arbolCadenas.last(); // Usamos last() para obtener la mayor cadena.
    }
    ...
    public Collection<String> getSiguientes(String cadena) {
        return arbolCadenas.tailSet(cadena, true); // tailSet devuelve todas las cadenas mayores o iguales a la dada.
    }
    ...
    public int getCantidadCadenas() {
        return arbolCadenas.size(); // size() devuelve la cantidad de elementos en el conjunto.
    }
    ...
    public void agregarCadena(String cadena) {
        arbolCadenas.add(cadena); // add() agrega la cadena al conjunto.
    }
    ...
    public void eliminarCadena(String cadena) {
        arbolCadenas.remove(cadena); // remove() elimina la cadena del conjunto.
    }
    ...
    public void eliminarCadenaSinMayusculasOMinusculas(String cadena) {
        arbolCadenas.removeIf(s -> s.equalsIgnoreCase(cadena)); // removeIf elimina cualquier cadena que coincida ignorando mayúsculas y minúsculas.
    }
    ...
    public void eliminarPrimera() {
        if (!arbolCadenas.isEmpty()) {
            arbolCadenas.pollFirst(); // pollFirst() elimina y retorna la primera cadena.
        }
    }
    ...
    public void reiniciarConjuntoCadenas(List<Object> objetos) {
        arbolCadenas.clear(); // Limpiamos el conjunto.
        for (Object obj : objetos) {
            arbolCadenas.add(obj.toString()); // Convertimos cada objeto a String y lo agregamos al conjunto.
        }
    }
    ...
    public void volverMayusculas() {
        NavigableSet<String> mayusculas = new TreeSet<>();
        for (String cadena : arbolCadenas) {
            mayusculas.add(cadena.toUpperCase()); // Convertimos cada cadena a mayúsculas.
        }
        arbolCadenas = mayusculas; // Reasignamos el conjunto modificado.
    }
    ...
    public TreeSet<String> invertirCadenas() {
        return new TreeSet<>(arbolCadenas.descendingSet()); // Creamos un nuevo TreeSet con el orden invertido.
    }
    ...
    public boolean compararElementos(String[] otroArreglo) {
        ...
        return true; // Si todos los elementos están presentes, retorna true.
    }
