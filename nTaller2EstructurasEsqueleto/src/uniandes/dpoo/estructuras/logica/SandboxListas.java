...
public class SandboxListas
{
    ...
    public List<Integer> getCopiaEnteros() {
        return new ArrayList<>(listaEnteros); // Creamos una nueva lista con los elementos de listaEnteros.
    }
    ...
    public List<String> getCopiaCadenas() {
        return new LinkedList<>(listaCadenas); // Creamos una nueva lista con los elementos de listaCadenas.
    }
    ...
    public int[] getEnterosComoArreglo() {
        ...
        for (int i = 0; i < listaEnteros.size(); i++) {
            arreglo[i] = listaEnteros.get(i); // Copiamos los elementos de la lista al arreglo.
        }
        return arreglo;
    }
    ...
    public int getCantidadEnteros() {
        return listaEnteros.size(); // Retorna el tamaño de la lista.
    }
    ...
    public int getCantidadCadenas() {
        return listaCadenas.size(); // Retorna el tamaño de la lista.
    }
    ...
    public void agregarEntero(int entero) {
        listaEnteros.add(entero); // Agregamos el entero al final de la lista.
    }
    ...
    public void agregarCadena(String cadena) {
        listaCadenas.add(cadena); // Agregamos la cadena al final de la lista.
    }
    ...
    public void eliminarEntero(int valor) {
        listaEnteros.removeIf(e -> e == valor); // Eliminamos todos los enteros que sean iguales al valor dado.
    }
    ...
    public void eliminarCadena(String cadena) {
        listaCadenas.removeIf(s -> s.equals(cadena)); // Eliminamos todas las cadenas que sean iguales a la cadena dada.
    }
    ...
    public void insertarEntero(int entero, int posicion) {
        if (posicion < 0) {
            listaEnteros.add(0, entero); // Insertamos al principio si la posición es menor que 0.
        } else if (posicion >= listaEnteros.size()) {
            listaEnteros.add(entero); // Insertamos al final si la posición es mayor que el tamaño de la lista.
        } else {
            listaEnteros.add(posicion, entero); // Insertamos en la posición especificada.
        }
    }
    ...
    public void eliminarEnteroPorPosicion(int posicion) {
        if (posicion >= 0 && posicion < listaEnteros.size()) {
            listaEnteros.remove(posicion); // Eliminamos el elemento en la posición dada si es válida.
        }
    }
    ...
    public void reiniciarArregloEnteros(double[] valores) {
        listaEnteros.clear(); // Limpiamos la lista.
        for (double valor : valores) {
            listaEnteros.add((int) valor); // Convertimos el valor a entero truncando y lo agregamos a la lista.
        }
    }
    ...
    public void reiniciarArregloCadenas(List<Object> objetos) {
        listaCadenas.clear(); // Limpiamos la lista.
        for (Object obj : objetos) {
            listaCadenas.add(obj.toString()); // Convertimos cada objeto a String y lo agregamos a la lista.
        }
    }
    ...
    public void volverPositivos() {
        for (int i = 0; i < listaEnteros.size(); i++) {
            ...
            if (valor < 0) {
                listaEnteros.set(i, -valor); // Multiplicamos por -1 los valores negativos.
            }
        }
    }
    ...
    public void organizarEnteros() {
        listaEnteros.sort((a, b) -> b - a); // Ordenamos la lista en orden descendente.
    }
    ...
    public void organizarCadenas() {
        listaCadenas.sort(String::compareTo); // Ordenamos la lista lexicográficamente.
    }
    ...
    public int contarApariciones(int valor) {
        ...
        for (int num : listaEnteros) {
            if (num == valor) {
                count++; // Contamos cada aparición del valor.
            }
        }
        return count;
    }
    ...
    public int contarApariciones(String cadena) {
        ...
        for (String str : listaCadenas) {
            if (str.equalsIgnoreCase(cadena)) {
                count++; // Contamos cada aparición de la cadena, ignorando mayúsculas y minúsculas.
            }
        }
        return count;
    }
    ...
    public int contarEnterosRepetidos() {
        ...
        for (int num : listaEnteros) {
            if (!unicos.add(num)) {
                repetidos.add(num); // Si no podemos agregarlo a unicos, es porque ya estaba, así que lo agregamos a repetidos.
            }
        }
        return repetidos.size(); // Devolvemos la cantidad de enteros que están repetidos.
    }
    ...
    public boolean compararArregloEnteros(int[] otroArreglo) {
        ...
        return true; // Si no encontramos diferencias, son iguales.
    }
    ...
    public void generarEnteros(int cantidad, int minimo, int maximo) {
        ...
        for (int i = 0; i < cantidad; i++) {
            int num = rand.nextInt(maximo - minimo + 1) + minimo; // Generamos un número aleatorio entre minimo y maximo.
